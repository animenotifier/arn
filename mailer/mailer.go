...
func SendEmailNotification(email string, notification *arn.Notification) error {
	...
	m.SetBody("text/html", "<h2>"+notification.Message+"</h2><p><a href='"+notification.Link+"' target='_blank'><img src='"+notification.Image+"' alt='Anime cover image' style='width:125px;height:181px;'></a></p>")
